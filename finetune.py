...
from tiny_llama.core.model import Transformer
from tiny_llama.core.tokenizer import Tokenizer
from tiny_llama.core.dataset import FineTuneDataset, custom_collate_fn
from tiny_llama.core.schedule import CosineDecayWithWarmupLRScheduler
from tiny_llama.core.lora import get_lora_state_dict
from tiny_llama.core.evaluation import masked_cross_entropy_loss, compute_evaluation_metrics
from tiny_llama.utils.file_helper import read_json_file, save_json_file
from tiny_llama.utils.logger import create_logger, pretty_print, log_metrics
from tiny_llama.utils.profiler import get_system_metrics, aggregate_metrics
from tiny_llama.utils.train_helper import set_seed, create_lora_model_and_load_checkpoint, create_optimizer
...
def parse_runtime_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Fine-tune tiny_llama script.')
    parser.add_argument(
        '--log-level',
        type=str,
        required=False,
